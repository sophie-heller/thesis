...
###########################################
###########################################
# data processing in variables file
# function for processing of tm and mdot of each stream to assign it to the corresponding layer and generating the list of dfs
def process_mdot_normal(mdot_normal, layers, layernumber_c, layernumber_l):
    """
    ...
    if not (len(layernumber_l) == 1 and layernumber_l[0] == 0):  # Check if layernumber_l is exactly [0]
